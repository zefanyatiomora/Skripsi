...
@section('content')
    ...
    <div class="container-fluid page-wrapper">
        ...
        <div class="form-card">
            ...
            <form id="formAreaFungsi" action="{{ route('area-fungsi.update', $areaFungsi->id_area_fungsi) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="kode_area_fungsi" class="form-control"
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="nama_area_fungsi" class="form-control"
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea name="deskripsi" class="form-control">{{ old('deskripsi', $areaFungsi->deskripsi) }}</textarea>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <a href="{{ route('area-fungsi.index') }}" class="btn btn-light border btn-back">
    ...
    <div class="popup-overlay" id="errorPopup">
        ...
        <div class="popup-box">
            ...
            <p>
                Mohon lengkapi seluruh data yang diperlukan sebelum memperbarui Area Fungsi.
            </p>
