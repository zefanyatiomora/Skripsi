...
<div class="container-fluid page-wrapper">
    ...
    <div class="form-card">
        ...
        <form action="{{ route('cluster-skill.store') }}"
            method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <select name="id_area_fungsi"
                    id="area_fungsi"
                    class="form-control @error('id_area_fungsi') is-invalid @enderror">
                    ...
                    @foreach($areaFungsi as $item)
                        ...
                        <option value="{{ $item->id_area_fungsi }}"
                            {{ old('id_area_fungsi') == $item->id_area_fungsi ? 'selected' : '' }}>
