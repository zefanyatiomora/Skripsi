...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="form-card">
            ...
            <form id="formScreening" action="{{ route('screening.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="pertanyaan" rows="4" class="form-control" required>{{ old('pertanyaan') }}</textarea>
    ...
    <script>
        ...
        document.getElementById('formScreening')
            .addEventListener('submit', function(e) {
                ...
                let pertanyaan =
                    document.querySelector('[name="pertanyaan"]')
                    .value
                    .trim();
    ...
    <div class="popup-overlay" id="errorPopup" style="display:none;">
        ...
        <div class="popup-box">
            ...
            <p>
                Mohon isi pertanyaan dan pilih minimal satu cluster skill sebelum menyimpan data.
            </p>
